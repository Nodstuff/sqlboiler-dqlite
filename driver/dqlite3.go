// Package driver is a dqlite driver.
package driver
...
func init() {
	drivers.RegisterFromInit("sqlite3", &DQLiteDriver{})
}
...
// DQLiteDriver holds the database connection string and a handle
// to the database connection.
type DQLiteDriver struct {
	connStr string
	dbConn  *sql.DB
}

// Templates that should be added/overridden
func (s DQLiteDriver) Templates() (map[string]string, error) {
...
// Assemble the db info
func (s DQLiteDriver) Assemble(config drivers.Config) (dbinfo *drivers.DBInfo, err error) {
	defer func() {
...
func (s DQLiteDriver) Open() error {
	var err error
...
func (s DQLiteDriver) Close() {
	s.dbConn.Close()
}

// TableNames connects to the sqlite database and
// retrieves all table names from sqlite_master
func (s DQLiteDriver) TableNames(schema string, whitelist, blacklist []string) ([]string, error) {
...
func (s DQLiteDriver) ViewNames(schema string, whitelist, blacklist []string) ([]string, error) {
...
func (s DQLiteDriver) ViewCapabilities(schema, name string) (drivers.ViewCapabilities, error) {
...
func (s DQLiteDriver) ViewColumns(schema, tableName string, whitelist, blacklist []string) ([]drivers.Column, error) {
...
func (s DQLiteDriver) tableInfo(tableName string) ([]*sqliteTableInfo, error) {
...
func (s DQLiteDriver) indexes(tableName string) ([]*sqliteIndex, error) {
	var ret []*sqliteIndex
...
func (s DQLiteDriver) Columns(schema, tableName string, whitelist, blacklist []string) ([]drivers.Column, error) {
...
func (s DQLiteDriver) PrimaryKeyInfo(schema, tableName string) (*drivers.PrimaryKey, error) {
...
func (s DQLiteDriver) ForeignKeyInfo(schema, tableName string) ([]drivers.ForeignKey, error) {
...
func (DQLiteDriver) TranslateColumnType(c drivers.Column) drivers.Column {
	if c.Nullable {
...
func (DQLiteDriver) Imports() (col importers.Collection, err error) {
